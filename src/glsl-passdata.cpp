...
void init(SDL_Surface* screen)
{
  ...
  initShader("shader/passdata.vs", "shader/passdata.frag", prog, vert, frag);
...
void display(SDL_Surface* screen)
{
  ...
  glVertexAttrib3f(index, 1.0, 0.0, 0.0);
  glVertex3f(0.0, 1.0, -4.0);
  glVertexAttrib3f(index, 0.0, 1.0, 0.0);
  glVertex3f(-1.0, -1.0, -4.0);
  glVertexAttrib3f(index, 0.0, 0.0, 1.0);
  glVertex3f(1.0, -1.0, -4.0);
  glEnd();
